      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Success in GEO isn't just about data. It's about a disciplined process that turns
            insight into action, and action into control. Genezio orchestrates this entire workflow,
            providing the clarity and confidence you need to master AI search.
          </p>
        </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 border border-slate-200 dark:border-slate-700 shadow-lg hover:shadow-xl transition-all duration-300 group">
                ...
                <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-xs">
                      <span className="text-slate-600 dark:text-slate-400">ChatGPT Visibility</span>
                    ...
                    <div className="flex items-center justify-between text-xs">
                      <span className="text-slate-600 dark:text-slate-400">Claude Mentions</span>
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                  Our platform monitors conversations across ChatGPT, Gemini, Google AI Overview,
                  and more. We pinpoint the exact prompts, topics, and user intents where your brand
                  is misrepresented, invisible, or being outmaneuvered by competitors.
                </p>
              </div>
                ...
                <div className="mb-6 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-xl">
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="ml-auto text-xs text-green-600 font-medium">Ready</div>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="ml-auto text-xs text-orange-600 font-medium">Queue</div>
                    </div>
                  </div>
                </div>

                <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                  Genezio delivers a prioritized list of actionable recommendations. Your team
                  receives a clear roadmap, enabling them to create and optimize the content needed
              ...
              <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 border border-slate-200 dark:border-slate-700 shadow-lg hover:shadow-xl transition-all duration-300 group">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                  Our analytics dashboards close the loop. We track the metrics that signal control:
                  share of voice against your key rivals, rank improvement for target prompts, and
                  measurable shifts in brand sentiment.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-20 text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              Join the brands already dominating AI search results. Get your comprehensive AI
              presence audit and start seeing results in weeks, not months.
            </p>
            <button
