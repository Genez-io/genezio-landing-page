            ...
            return (
              ...
              >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[300px] md:min-h-[400px]">
                  ...
                  {/* Right Column - Visual */}
                  <div className="p-6 md:p-8 lg:p-12 flex items-center justify-center bg-gradient-to-br from-blue-500/5 via-purple-500/5 to-transparent">
                    {/* Render different visuals based on card type */}
                    {item.visual === "conversation" ? (
                      // Multi-turn conversation visual with skeleton messages
                      <div className="w-full space-y-3">
                        {/* Message 1 - User */}
                        <div className="flex justify-end">
                          <div className="bg-blue-500/20 border border-blue-500/30 rounded-lg p-4 max-w-[75%]">
                            <div className="h-3 bg-blue-400/30 rounded w-48" />
                          </div>
                        </div>
                        {/* Message 2 - AI */}
                        <div className="flex justify-start">
                          <div className="bg-[#1C1C20]/80 border border-blue-500/20 rounded-lg p-4 max-w-[75%]">
                            <div className="space-y-2">
                              <div className="h-3 bg-gray-600/30 rounded w-56" />

                              <div className="h-3 bg-gray-600/30 rounded w-44" />
                            </div>
                          </div>
                        </div>
                        {/* Message 3 - User */}
                        <div className="flex justify-end">
                          <div className="bg-blue-500/20 border border-blue-500/30 rounded-lg p-4 max-w-[75%]">
                            <div className="h-3 bg-blue-400/30 rounded w-40" />
                          </div>
                        </div>
                        {/* Message 4 - AI */}
                        <div className="flex justify-start">
                          <div className="bg-[#1C1C20]/80 border border-blue-500/20 rounded-lg p-4 max-w-[75%]">
                            <div className="space-y-2">
                              <div className="h-3 bg-gray-600/30 rounded w-52" />

                              <div className="h-3 bg-gray-600/30 rounded w-36" />
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="bg-[#1C1C20]/80 border border-purple-500/20 rounded-lg p-4">
                            <p className="text-purple-300 text-sm font-medium">
                              What is the best platform to buy toys from?
                            </p>
                          </div>
                        </div>
                      </div>
