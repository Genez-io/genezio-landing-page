...
export function AgentsSection() {
  const agents = [
    {
      ...
      icon: <CheckCircleIcon className="w-8 h-8 text-green-500" id="07sjod" />,
    ...
    },
    {
      ...
      icon: <AlertTriangleIcon className="w-8 h-8 text-red-500" id="nfsf88" />,
    ...
    },
    {
      ...
      icon: <FilterIcon className="w-8 h-8 text-amber-500" id="k76dbs" />,
    ...
    },
    {
      ...
      icon: <DollarSignIcon className="w-8 h-8 text-green-600" id="v24jhr" />,
    ...
    },
    {
      ...
      icon: <AlertTriangleIcon className="w-8 h-8 text-red-500" id="fakeid1" />,
    ...
    },
    {
      ...
      icon: <BriefcaseIcon className="w-8 h-8 text-blue-500" id="fakeid2" />,
    ...
    },
    {
      ...
      icon: <TestTubeIcon className="w-8 h-8 text-purple-600" id="fakeid3" />,
    ...
    },
    {
      ...
      icon: <LockIcon className="w-8 h-8 text-slate-600" id="fakeid4" />,
  ...
  return (
    <section className="py-20 bg-slate-50 dark:bg-slate-800" id="7563sd">
      <div className="container mx-auto px-4 md:px-6" id="hw655k">
        <div className="max-w-3xl mx-auto text-center mb-16" id="4s0ein">
          <div
            className="inline-flex items-center px-3 py-1 rounded-full bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300 text-sm font-medium mb-4"
            id="rbcubm"
          >
            <ClockIcon className="w-4 h-4 mr-2" id="8zram9" />
          ...
          <p className="text-xl text-slate-600 dark:text-slate-300" id="fu6g5n">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8" id="n3432w">
