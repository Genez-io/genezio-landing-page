  ...
  return (
    <section className="py-16 md:py-28 bg-[#050506] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6 relative z-10 text-center">
        {/* Icon */}
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-blue-500/20 mb-8">
        ...
        <div className="mt-16 mx-auto w-48 h-px bg-gradient-to-r from-transparent via-emerald-500/50 to-transparent" />
      </div>
    </section>
  );
}
