...
export function VerticalsSection() {
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 md:px-6" id="cprru4">
        <div className="max-w-3xl mx-auto text-center mb-16" id="cc6eqq">
          <h2
          ...
          <p className="text-xl text-slate-600 dark:text-slate-300" id="vmdu5z">
            Ensuring AI accuracy, compliance, and security across critical
            sectors.
          </p>
        </div>

        <div className="grid md:grid-cols-3 gap-8" id="x9wsws">
