          ...
          {values.map((value, index) => {
            ...
            return (
              ...
              >
                {/* Gradient top border */}
                <div
                  className={`absolute top-0 left-0 right-0 h-1 ${value.color} rounded-t-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                />

                <div className="flex items-start gap-5">
                  {/* Icon */}
                  <div
                    className={`flex-shrink-0 w-14 h-14 rounded-lg ${value.color} p-[1px]`}
                  >
