        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div className="relative max-w-md ml-auto">
              <div className="absolute -inset-3 bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-3xl blur-2xl" />
              <div className="relative bg-[#0E0E12] border border-blue-500/25 rounded-3xl rounded-bl-md p-7 md:p-8 shadow-2xl shadow-purple-500/10">
