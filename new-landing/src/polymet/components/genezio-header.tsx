  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-md border-b border-white/5">
          ...
          <div className="relative" ref={platformMenuRef}>
            <button
              onClick={() => {
                ...
                if (!platformMenuOpen) setResourcesMenuOpen(false);
              }}
            ...
            <div
              ...
              className={`absolute top-full left-0 mt-6 w-[720px] bg-[#0E0E10] border border-white/10 rounded-2xl shadow-2xl overflow-hidden transition-all duration-200 ease-out z-50 ${
                platformMenuOpen
          ...
          <div className="relative" ref={resourcesMenuRef}>
            <button
              onClick={() => {
                ...
                if (!resourcesMenuOpen) setPlatformMenuOpen(false);
              }}
            ...
            <div
              id="resources-menu"
              aria-hidden={!resourcesMenuOpen}
              className={`absolute top-full left-0 mt-6 w-[560px] bg-[#0E0E10] border border-white/10 rounded-2xl shadow-2xl overflow-hidden transition-all duration-200 ease-out z-50 ${
                resourcesMenuOpen
                  ? "opacity-100 translate-y-0 pointer-events-auto visible"
                  : "opacity-0 -translate-y-2 pointer-events-none invisible"
              }`}
                ...
                <div className="grid grid-cols-2 gap-6">
                  {[
                    ...
                    <div
                      key={group.heading}
                      className={
                        gi > 0 ? "md:border-l md:border-white/10 md:pl-6" : ""
                      }
                    >
      ...
      <div
        ...
        className={`md:hidden bg-black/95 backdrop-blur-md border-t border-white/5 transition-all duration-200 ease-out ${
