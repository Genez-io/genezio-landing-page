          ...
          <div className="max-w-none">
            <div className="space-y-10 text-muted-foreground leading-relaxed text-justify">
              <p className="text-justify">
                ...
                defined in the foregoing SSA (“Agreement”). These Support Terms apply to the
                Software for which Genezio received payment of the corresponding Fees as per the
                Agreement. All capitalized terms not otherwise defined here will have the meaning
                specified in the Agreement. The Support Terms may be regularly updated by Genezio.
              </p>
              <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">1. Definitions</h2>
              <ul className="space-y-5">
                <li>
                  <strong>“Incident”</strong> means failure of the Software components to function
                  in accordance with the specifications in the Documentation or the Order (as the
                  case may be), excluding issues due to Customer’s misuse, other third-party
                  applications, Customer Data, Customer Applications or Third-Party Services, or for
                  those caused by Exclusions;
                </li>
                <li>
                  <strong>“Downtime for Updates”</strong> means the period of time reserved by
                  Genezio to apply, fix and update the Software as part of regular maintenance,
                  according to the Genezio’s internal policies;
                </li>
                <li>
                  <strong>“Service Requests”</strong> means a request from the Customer that does
                  not meet the criteria for an Incident, and that is limited to information or
                  advice on Software use instructions, activation, licensing, etc.;
                </li>
                <li>
                  <strong>“Ticket”</strong> means the ticketing system used by Genezio to receive
                  requests regarding Incidents and Service Requests, which will be communicated to
                  the Customer.
                </li>
              </ul>
              ...
              <p>
                ...
                permission, database provisioning or other issues related to its systems, networks
                or applications interacting with the Software.
              </p>
              <p>
                <strong>Incident Support.</strong> During the Subscription Term, Genezio will
                provide support and maintenance for Incidents, by providing maintenance and
              ...
              <p>
                ...
                hourly rate specified in the applicable Order or at a rate otherwise agreed in
              ...
              <ol className="list-lower-roman pl-8 space-y-2 mt-4">
                <li>
                  the Software components have been changed, modified or damaged by the Customer or
                  by anyone other than Genezio without Genezio’s consent or knowledge or in breach
                  of the Agreement;
                </li>
                <li>
                ...
                <li>
                  the Incident is due to a third-party software, Customer Data, Customer
                  Applications or by Third-Party Services or by a Customer integration; or
                </li>
                <li>
              ...
              <p className="mb-3">The following support service levels are defined and apply:</p>
                  ...
                  <tbody className="[&amp;_tr:last-child]:border-0">
                    <tr className="border-b transition-colors bg-red-50">
                      ...
                      <td className="p-2 align-middle [&amp;:has([role=checkbox])]:pr-0 [&amp;&gt;[role=checkbox]]:translate-y-[2px]">
                        The Software is not working, and they cannot be used in any way by the
                        Customer.
                      </td>
                      <td className="p-2 align-middle [&amp;:has([role=checkbox])]:pr-0 [&amp;&gt;[role=checkbox]]:translate-y-[2px] font-semibold">
                    ...
                    <tr className="border-b transition-colors ">
                      ...
                      <td className="p-2 align-middle [&amp;:has([role=checkbox])]:pr-0 [&amp;&gt;[role=checkbox]]:translate-y-[2px]">
                        ...
                        operational, but can still be used in a limited capacity until the issues
                        are resolved.
                      </td>
                      <td className="p-2 align-middle [&amp;:has([role=checkbox])]:pr-0 [&amp;&gt;[role=checkbox]]:translate-y-[2px] font-semibold">
                    ...
                    <tr className="border-b transition-colors bg-blue-50">
                      ...
                      <td className="p-2 align-middle [&amp;:has([role=checkbox])]:pr-0 [&amp;&gt;[role=checkbox]]:translate-y-[2px]">
                        A medium-priority error refers to a situation where the Software is facing
                        minor issues that do not affect its overall functionality and can be
                        deferred until the problems are resolved.
                      </td>
                      <td className="p-2 align-middle [&amp;:has([role=checkbox])]:pr-0 [&amp;&gt;[role=checkbox]]:translate-y-[2px] font-semibold">
                    ...
                    <tr className="border-b transition-colors ">
                      ...
                      <td className="p-2 align-middle [&amp;:has([role=checkbox])]:pr-0 [&amp;&gt;[role=checkbox]]:translate-y-[2px]">
                        A low-priority error refers to other Software related Incidents that do not
                        fall under the Critical/High/Medium levels.
                      </td>
                      <td className="p-2 align-middle [&amp;:has([role=checkbox])]:pr-0 [&amp;&gt;[role=checkbox]]:translate-y-[2px] font-semibold">
              ...
              <p className="mt-8 ">
                * Genezio will provide Incident support during business days, Monday to Friday
                except national holidays in Romania (“Business Days”), between 9:00 and 18:00 EET
                during Business Days (“Working Hours”). The response times elapse only during
                Working Hours and Tickets remain on hold outside of these hours.
                <br />
                <br />
                ...
                Incident and add these details in the Ticket. Genezio will evaluate the Priority
                Level and confirm or recategorize it. Customer must submit Incidents and Service
                ...
                Priority Level, Genezio will target the first response times noted above. Genezio
                will make commercially reasonable efforts to respond to Service Requests, but is not
                bound by the response times prescribed herein.
              </p>
              <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">
              ...
              Genezio to adequately address the potential problem; (iii) utilize sufficient
              resources to understand the instructions from Genezio in addressing the problem, and
              make reasonable attempts to correct the problem as suggested by Genezio.
              <p className="mt-2">
                The Customer acknowledges that the time required for resolution of Incidents may
                vary depending on the specific circumstances of each problem, including, without
