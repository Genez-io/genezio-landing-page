            ...
            <div className="space-y-10 text-muted-foreground leading-relaxed text-justify">
              <div style={{ minWidth: "100%", display: "table" }}>
                <p className="whitespace-pre-wrap">
                  ...
                  Date”), provided the Applicable Data Protection Legislation requires the signing
                  of a data processing agreement or similar, case in which this DPA becomes an
                  addendum to and forms an integral part of the Main Agreement. By entering into the
                  Main Agreement or by using the Products, Customer agrees to be bound by this DPA
                ...
                <p className="whitespace-pre-wrap">
                  ...
                  Protection Legislation. "Applicable Data Protection Legislation" means where
                  applicable, Regulation (EU) 2016/679 regarding the Personal Data Protection
                  ("GDPR") and any other applicable law which governs the agreements between the
                  Parties in the field of data protection and which require the signing of a data
                  protection agreement (such as the UK Data Protection Act 2018).
                </p>
                <p>
                ...
                <h4 className="text-lg font-semibold mt-8 mb-4 text-white">Instructions</h4>
                <p>
                ...
                <h4 className="text-lg font-semibold mt-8 mb-4 text-white">Purpose limitation</h4>
                <p>
                ...
                <h4 className="text-lg font-semibold mt-8 mb-4 text-white">Sensitive data</h4>
                <p>
                ...
                <p>
                  The processor shall deal with inquiries from the controller about the processing
                  of data in accordance with these Clauses.
                </p>
                <p>
                ...
                <p>
                  ...
                  the concerned sub-processor(s). The processor shall provide the controller with
                  the information necessary to enable the controller to exercise the right to
                  object. If processor does not receive a written notice of objection and
                  termination in accordance with this section, it will be deemed in good faith that
                  the controller has accepted the change in sub-processors. If the Customer does not
                  agree with any new sub-processor, it has the sole right to immediately terminate
                  the Main Agreement and the DPA.
                </p>
                <h4 className="text-lg font-semibold mt-8 mb-4 text-white">
                ...
                <p>
                  ...
                  controller's personal data to third-countries by using standard contractual
                  clauses adopted by the Commission in accordance with of Article 46(2) of
                  Regulation (EU) 2016/679 provided the conditions for the use of those standard
                  contractual clauses are met, or adequacy decisions.
                </p>
                <h4 className="text-lg font-semibold mt-8 mb-4 text-white">
                ...
                <p>
                  The Parties shall set out in Annex III the appropriate technical and
                  organisational measures by which the processor is required to assist the
                  controller in the application of this Clause as well as the scope and the extent
                ...
                <p>
                  ...
                  Legislation, where applicable, taking into account the nature of processing and
                ...
                <ul className="list-disc pl-8 space-y-2 mt-4">
                  ...
                  <li>
                    ...
                    delay the personal data breach to the data subject, when the personal data
                ...
                <ul className="list-disc pl-8 space-y-2 mt-4">
                  ...
                  <li>
                    the details of a contact point where more information concerning the personal
                    data breach can be obtained;
                  </li>
                  <li>
                    its likely consequences and the measures taken or proposed to be taken to
                ...
                <p>
                  ...
                  terminated. The processor shall promptly inform the controller in case it is
