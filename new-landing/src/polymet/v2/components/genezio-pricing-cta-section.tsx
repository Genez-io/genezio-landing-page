      ...
      <div className="px-6 md:px-8 lg:px-12 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative rounded-2xl border-2 border-border bg-card/80 backdrop-blur-sm p-8 md:p-12 shadow-2xl">
            {/* Decorative elements */}
            <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 rounded-full bg-emerald-500 flex items-center justify-center shadow-lg">
            ...
            <div className="absolute -bottom-px left-0 right-0 h-px bg-gradient-to-r from-transparent via-emerald-500 to-transparent" />
          </div>

          {/* Floating elements */}
          <div className="absolute -top-8 -left-8 w-32 h-32 bg-emerald-500/20 rounded-full blur-3xl" />
