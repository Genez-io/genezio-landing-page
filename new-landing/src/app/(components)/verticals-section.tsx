  ...
  const verticals = [
    {
      ...
      icon: (
        <ShoppingCartIcon className="w-12 h-12 text-purple-600 dark:text-purple-400" />
      ),
    ...
    },
    {
      ...
      icon: (
        <LandmarkIcon className="w-12 h-12 text-blue-600 dark:text-blue-400" />
      ),
    ...
    },
    {
      ...
      icon: (
        <HeartIcon className="w-12 h-12 text-green-600 dark:text-green-400" />
      ),
