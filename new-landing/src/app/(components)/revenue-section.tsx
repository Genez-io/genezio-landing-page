      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300 text-sm font-medium mb-4">
              {/* <TrendingUpIcon className="w-4 h-4 mr-2 text-green-600 dark:text-green-400" /> */}
              For Marketers
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-4">
              Monetize your brand/product presence across LLM
            </h2>
          </div>
          ...
          <div className="grid lg:grid-cols-1 gap-8">
            ...
            <div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-8 border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-all duration-300">
              <div className="flex items-start space-x-4 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-slate-900 dark:text-white mb-2">
                    Chatbot Lead Generation & Conversion
                  </h3>
                  <p className="text-slate-600 dark:text-slate-300">
